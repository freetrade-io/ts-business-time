...
import { IBusinessTimeConstraint, IBusinessDayConstraint } from "./BusinessTimeConstraint"
...
export class AnyTime extends CombinatorialConstraint
    implements IBusinessTimeConstraint, IBusinessTimeNarrator, IBusinessDayConstraint {
