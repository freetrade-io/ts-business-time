...
describe.skip("rounding business time in a time zone", () => {
    ...
    test.each([
        ...
        "round to hour in timezone with low minutes",
        (
            timeZoneName: string,
            localTime: string,
            expectedRoundedLocalTime: string,
        ) => {
            ...
            const rounded = businessTime.rounded(moment.duration(1, "hour"))

            // Then we should get the expected rounded local time.
            expect(rounded.getMoment().tz()).toBe(timeZoneName)
            expect(rounded.format(localTimeFormat)).toBe(
                expectedRoundedLocalTime,
            )
        },
    )
    ...
    test.each([
        ...
        "round to hour in timezone with high minutes",
        (
            timeZoneName: string,
            localTime: string,
            expectedRoundedLocalTime: string,
